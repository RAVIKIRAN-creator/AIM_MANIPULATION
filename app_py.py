...
st.title("📊 Financial Manipulation Prediction")
...
features = np.array([[dsri, gmi, aqi, sgi, depi, sgai, lvgi, tata]])

if st.button("Predict"):
    prediction = model.predict(features)[0]

    if prediction == 1:
        st.error("⚠️ Data is likely MANIPULATED")
    else:
        st.success("✅ Data is NOT manipulated")